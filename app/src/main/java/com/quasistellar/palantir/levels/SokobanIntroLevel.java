...
*/	
	...
	public String tileDesc(int tile) {
		...
		case Terrain.BLACK_SOKOBAN_SHEEP:
			return "";
		case Terrain.FLEECING_TRAP:
			return "Stepping onto a fleecing trap will kill you. Even if you are a sheep...";
		case Terrain.CHANGE_SHEEP_TRAP:
			return "This trap will change the form of any sheep in the certain order.";
		case Terrain.SOKOBAN_ITEM_REVEAL:
			return "This switch creates an item somewhere on the level.";
		case Terrain.SOKOBAN_PORT_SWITCH:
			return "This switch turns on and off a portal somewhere. You can trace the direction of this effect and determine which portal is connected to it.";
		case Terrain.PORT_WELL:
	...
	protected void createItems() {
		 for (int i = 0; i < LENGTH; i++) {				
			if (map[i]==Terrain.SOKOBAN_HEAP){
				drop(new Stone1.GreenStone(), i).type = Heap.Type.CHEST;
			}
		 }

		drop(new Diamond1.GreenDiamond(), 4 + WIDTH * 15);
