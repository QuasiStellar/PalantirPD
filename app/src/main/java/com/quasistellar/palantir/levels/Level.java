...
import com.quasistellar.palantir.actors.buffs.MindVision;
import com.quasistellar.palantir.actors.buffs.Shadows;
...
import com.quasistellar.palantir.actors.mobs.pets.BlueDragon;
import com.quasistellar.palantir.actors.mobs.pets.Bunny;
import com.quasistellar.palantir.actors.mobs.pets.Fairy;
import com.quasistellar.palantir.actors.mobs.pets.GreenDragon;
import com.quasistellar.palantir.actors.mobs.pets.PET;
import com.quasistellar.palantir.actors.mobs.pets.RedDragon;
import com.quasistellar.palantir.actors.mobs.pets.Scorpion;
import com.quasistellar.palantir.actors.mobs.pets.ShadowDragon;
import com.quasistellar.palantir.actors.mobs.pets.Spider;
import com.quasistellar.palantir.actors.mobs.pets.SugarplumFairy;
import com.quasistellar.palantir.actors.mobs.pets.Velocirooster;
import com.quasistellar.palantir.actors.mobs.pets.VioletDragon;
import com.quasistellar.palantir.actors.mobs.pets.bee;
import com.quasistellar.palantir.effects.Pushing;
import com.quasistellar.palantir.effects.particles.FlowParticle;
import com.quasistellar.palantir.effects.particles.WindParticle;
...
import com.quasistellar.palantir.items.Torch;
...
import com.quasistellar.palantir.levels.traps.HeapGenTrap;
...
import com.quasistellar.palantir.mechanics.ShadowCaster;
		...
		if (c.isAlive()) {
			if (c.buff(MindVision.class) != null) {
				for (Mob mob : mobs) {
					...
					&& ((Hero) c).heroClass == HeroClass.WARRIOR) {
				for (Mob mob : mobs) {
					int p = mob.pos;
