...
public class WndStory extends Window {
	...
	static {
		...
		CHAPTERS.put(
				ID_SOKOBAN1,
				"I might find possible vulnerabilities and review this stage for consistency with my plan.\n\n" +
						"Some parts of the level are hidden and can be explored using search button in my toolbar. " +
						"Also certain elements of the stage can affect others, so I should track the direction of that kind of effects...");
		CHAPTERS.put(
				ID_SOKOBAN2,
	...
	public WndStory(String text) {
		...
		tf.maxWidth = Palantir.landscape() ? WIDTH_L - MARGIN * 2
				: WIDTH_P - MARGIN * 2;
		tf.measure();
		tf.ra = bgR;
		tf.ga = bgG;
