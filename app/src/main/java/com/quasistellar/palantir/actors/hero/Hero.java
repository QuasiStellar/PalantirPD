...
import com.quasistellar.palantir.Bones;
...
import com.quasistellar.palantir.actors.buffs.Blindness;
...
import com.quasistellar.palantir.actors.buffs.Combo;
...
import com.quasistellar.palantir.actors.buffs.Fury;
...
import com.quasistellar.palantir.actors.buffs.ManaRegen;
...
import com.quasistellar.palantir.actors.buffs.Regeneration;
import com.quasistellar.palantir.actors.buffs.Roots;
import com.quasistellar.palantir.actors.buffs.SnipersMark;
...
import com.quasistellar.palantir.actors.mobs.SokobanSentinel;
...
import com.quasistellar.palantir.effects.CheckedCell;
...
import com.quasistellar.palantir.items.Ankh;
...
import com.quasistellar.palantir.items.armor.glyphs.Viscosity;
...
import com.quasistellar.palantir.items.keys.GoldenKey;
import com.quasistellar.palantir.items.keys.GoldenSkeletonKey;
import com.quasistellar.palantir.items.keys.IronKey;
import com.quasistellar.palantir.items.keys.Key;
...
import com.quasistellar.palantir.levels.features.AlchemyPot;
import com.quasistellar.palantir.levels.features.Chasm;
import com.quasistellar.palantir.levels.features.Sign;
import com.quasistellar.palantir.levels.features.Trap;
...
import com.quasistellar.palantir.scenes.SurfaceScene;
import com.quasistellar.palantir.sprites.CharSprite;
import com.quasistellar.palantir.sprites.HeroSprite;
import com.quasistellar.palantir.ui.AttackIndicator;
import com.quasistellar.palantir.ui.BuffIndicator;
import com.quasistellar.palantir.ui.QuickSlotButton;
import com.quasistellar.palantir.utils.GLog;
import com.quasistellar.palantir.windows.WndAscend;
import com.quasistellar.palantir.windows.WndDescend;
import com.quasistellar.palantir.windows.WndDewVial;
import com.quasistellar.palantir.windows.WndLevelUp;
import com.quasistellar.palantir.windows.WndMessage;
import com.quasistellar.palantir.windows.WndResurrect;
import com.quasistellar.palantir.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	private static final String TXT_LEAVE = "No way back.";
...
*/
		...
		if (Level.adjacent(pos, target)) {
			...
			if (Actor.findChar(target) == null) {
				if (Level.pit[target] && !flying && !Chasm.jumpConfirmed) {
					...
					return false;
				} else if (Level.avoid[target] && !flying && !Trap.stepConfirmed) {
					Trap.heroStep(this);
					interrupt();
					return false;
	...
	public void die(Object cause) {
		...
		if (cause instanceof SokobanSentinel) {
			Badges.validateDeathFromStatue();
		}
	...
	public void restart(int resetLevel) {

		HP = HT;
		Dungeon.gold = 0;
		exp = 0;

		belongings.restart(resetLevel);
