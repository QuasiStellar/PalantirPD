...
public class Diamond5 extends Item {
	...
	public static class PurpleDiamond extends Item {
		...
		public boolean doPickUp(Hero hero) {
			Diamond5 stone = hero.belongings.getItem(Diamond5.class);
