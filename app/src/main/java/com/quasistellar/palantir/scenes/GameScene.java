...
import com.quasistellar.palantir.DungeonTilemap;
import com.quasistellar.palantir.FogOfWar;
...
import com.quasistellar.palantir.effects.EmoIcon;
import com.quasistellar.palantir.effects.Flare;
import com.quasistellar.palantir.effects.FloatingText;
import com.quasistellar.palantir.effects.Ripple;
import com.quasistellar.palantir.effects.SpellSprite;
import com.quasistellar.palantir.items.Heap;
import com.quasistellar.palantir.items.Honeypot;
...
import com.quasistellar.palantir.levels.RegularLevel;
...
import com.quasistellar.palantir.sprites.DiscardedItemSprite;
import com.quasistellar.palantir.sprites.HeroSprite;
import com.quasistellar.palantir.sprites.ItemSprite;
import com.quasistellar.palantir.sprites.PlantSprite;
import com.quasistellar.palantir.ui.AttackIndicator;
import com.quasistellar.palantir.ui.Banner;
import com.quasistellar.palantir.ui.BusyIndicator;
import com.quasistellar.palantir.ui.GameLog;
import com.quasistellar.palantir.ui.HealthIndicator;
import com.quasistellar.palantir.ui.LootIndicator;
import com.quasistellar.palantir.ui.QuickSlotButton;
import com.quasistellar.palantir.ui.ResumeIndicator;
import com.quasistellar.palantir.ui.StatusPane;
import com.quasistellar.palantir.ui.Toast;
import com.quasistellar.palantir.ui.Toolbar;
import com.quasistellar.palantir.ui.Window;
import com.quasistellar.palantir.utils.GLog;
import com.quasistellar.palantir.windows.WndBag;
import com.quasistellar.palantir.windows.WndBag.Mode;
import com.quasistellar.palantir.windows.WndGame;
import com.quasistellar.palantir.windows.WndStory;
...
public class GameScene extends PixelScene {
	...
	private static final String TXT_WELCOME = "Welcome to the level %d of Otiluke's Castle!";
	private static final String TXT_WELCOME_BACK = "Welcome back to the level %d of Otiluke's Castle!";
	...
	public void create() {
		...
		Palantir.lastClass(Dungeon.hero.heroClass.ordinal());

		super.create();
		Camera.main.zoom(defaultZoom + Palantir.zoom());
		...
		brightness(Palantir.brightness());
