...
public class Diamond1 extends Item {
	...
	public static class GreenDiamond extends Item {
		...
		public boolean doPickUp(Hero hero) {
			Diamond1 stone = hero.belongings.getItem(Diamond1.class);
