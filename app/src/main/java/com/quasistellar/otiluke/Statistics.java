...
public class Statistics {
	...
	public static int stones_col;
	public static int crystals_col;
	...
	public static void storeInBundle(Bundle bundle) {
		...
		bundle.put(STONES, stones_col);
		bundle.put(CRYSTALS, crystals_col);
	...
	public static void restoreFromBundle(Bundle bundle) {
		...
		stones_col = bundle.getInt(STONES);
		crystals_col = bundle.getInt(CRYSTALS);
