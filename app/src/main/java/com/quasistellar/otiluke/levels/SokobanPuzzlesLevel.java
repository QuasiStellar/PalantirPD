...
import com.quasistellar.otiluke.items.Whistle;
	...
	protected void createItems() {
		for (int i = 0; i < LENGTH; i++) {
			if (map[i]==Terrain.SOKOBAN_HEAP){
				drop(new Stone4.PurpleStone(), i).type = Heap.Type.CHEST;
			}
		}

//		drop(new Stone4.PurpleStone(), 15 + WIDTH * 32).type = Heap.Type.CHEST;

		drop(new Diamond4.PurpleDiamond(), 38 + WIDTH * 16);
		 ...
		 addItemToGen(new IronKey(Dungeon.depth) , 6, 15 + WIDTH * 4);

		 addItemToGen(new Stone4.PurpleStone() , 7, 42 + WIDTH * 3);
		 addItemToGen(new Stone4.PurpleStone() , 8, 42 + WIDTH * 4);
		 addItemToGen(new Stone4.PurpleStone() , 9, 42 + WIDTH * 5);
		 addItemToGen(new Stone4.PurpleStone() , 10, 42 + WIDTH * 6);
		 addItemToGen(new Stone4.PurpleStone() , 11, 42 + WIDTH * 7);
		 addItemToGen(new Stone4.PurpleStone() , 12, 42 + WIDTH * 8);
		 addItemToGen(new Stone4.PurpleStone() , 13, 42 + WIDTH * 9);
		 addItemToGen(new Stone4.PurpleStone() , 14, 42 + WIDTH * 10);
