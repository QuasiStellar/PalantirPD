...
import com.quasistellar.otiluke.effects.BannerSprites.Type;
import com.quasistellar.otiluke.effects.Speck;
import com.quasistellar.otiluke.ui.Archs;
import com.quasistellar.otiluke.ui.ExitButton;
...
import com.quasistellar.otiluke.windows.WndChallenges;
import com.quasistellar.otiluke.windows.WndClass;
...
public class StartScene extends PixelScene {
	...
	public static HeroClass curClass = HeroClass.WARRIOR;
	...
	public void create() {
		...
		curClass = null;
		updateClass(HeroClass.values()[Palantir.lastClass()]);
	...
	private class ChallengeButton extends Button {
		...
		protected void createChildren() {
			...
			image = Icons
					.get(Palantir.challenges() > 0 ? Icons.CHALLENGE_ON
							: Icons.CHALLENGE_OFF);
			add(image);
		}
		...
		protected void onClick() {
			if (false) {
				StartScene.this.add(new WndChallenges(Palantir
						.challenges(), true) {
					@Override
