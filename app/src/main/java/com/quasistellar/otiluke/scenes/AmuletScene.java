...
public class AmuletScene extends PixelScene {
	...
	private static final String TXT = "Your mission ends here. It's time to return.";
	...
	public void create() {
		...
		RedButton btnExit = new RedButton(TXT_EXIT) {
			...
			protected void onClick() {
				Integer dur = Math.round(Statistics.duration);
				Dungeon.win(dur.toString()+" turns");
		...
		new Flare(8, 48).color(0xC0BDFF, true).show(amulet, 0).angularSpeed = +30;
